...
export default function SearchBar({ className = "" }) {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="inline-flex items-center justify-center gap-2 rounded-lg bg-navy-800 hover:bg-navy-900 text-white font-semibold text-sm px-6 py-2.5 transition-colors"
      >
